...
<head>
	...
	<link rel="stylesheet" href="css/estilo_proyecto.css"> <!-- Enlazamos el archivo de estilos CSS del carrusel -->
...
<header class="cafe-header">
      ...
      <div class="header-text">
        ...
        <a href="admin/Productos/mostrarprod.php">Productos</a>
            ...
            if (isset($_SESSION['roles'])  ) {
              if($_SESSION['roles'] == 3 || $_SESSION['roles'] == 1 ){
    ...
    <div class="contenedor-imagen">
      ...
      <img src="img/cafeteria2.jpg" alt="Imagen" class="responsive-image">
  ...
  <div class="image-container">
    <a href="Otros/pedido.php">
      <img src="img/pedido.jpg" alt="Imagen 3">
      <div class="overlay">
        <center><p class="text">Pedidos</p></center>
      </div>
    </a>
  </div>
</div>
