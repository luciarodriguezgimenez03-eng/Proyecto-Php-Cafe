...
<?php
        ...
        $query = "SELECT usuario.id, usuario.nombre , pedidos.estado
     ...
     while ($rows = mysqli_fetch_assoc($resultado)) {
        ...
        if ($rolUsuario == 3 || $rolUsuario == 1) {
          ...
          echo "<td>"."Estado: "."<a href='estado.php?id=".$rows["id"]."'>".$rows["estado"]."</a>"."</td>";
        }else{
          echo "<td>"."Estado: "."<a>".$rows["estado"]."</a>"."</td>";

        }
        
        echo "<td>". "<a href='linea_pedido.php?id=". $rows["id"]."'>MÁS DETALLES</a>"."</td>";
